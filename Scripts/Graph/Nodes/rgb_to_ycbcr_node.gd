...
func _ready():
	...
	add_child(hbox2)
	set_slot(2, false, universal_type, Color.BLACK, true, universal_type, y_color)
	...
	add_child(hbox3)
	set_slot(3, false, universal_type, Color.BLACK, true, universal_type, cr_color)
	...
	add_child(hbox4)
	set_slot(4, false, universal_type, Color.BLACK, true, universal_type, cb_color)
